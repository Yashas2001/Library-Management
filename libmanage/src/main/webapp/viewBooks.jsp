...
@media only screen and (max-width: 600px) {#main {margin-left: 0}}
    ...
    <body>
        ...
        <br>
        <br>
<h2 align="center"><font color="white"><strong>List of Books</strong></font></h2>
<table bgcolor="white" border="1" align="center" cellpadding="4" cellspacing="4">
<tr>
