...
<table bgcolor="white" width="300" height="100" border="0" cellspacing="10" cellpadding="0" align="center"><%
    try{
		...
		//java.util.Date date=formatter.parse(request.getParameter("return_date"));
		//DateFormat oDateFormat = new SimpleDateFormat("yyyy/MM/dd");
        
        //String return_date = oDateFormat.format(date);
        String rDate = request.getParameter("return_date");

        //out.println(username + "::: " + userType);
        Class.forName("com.mysql.jdbc.Driver");  // MySQL database connection
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?" , "user", "Yashas2001");
    ...
    //    Date strDate = sdf.parse(sdf);
        ...
        //String sql="INSERT INTO returned_books(BID,UID,FINE,RETURN_DATE) VALUES (?,?,?,?)";
//        PreparedStatement pstm = conn.prepareStatement(sql);
        
        PreparedStatement pstm = conn.prepareStatement("INSERT INTO returned_books(BID,UID,FINE,RETURN_DATE) VALUES (?,?,?,?)");
        
        pstm.setString(1,bid );
        pstm.setString(2,uid );
        //pstm.setDate(3,date);
        pstm.setString(3,fine);
...
<center><h1> <B>Book Returned successfully</B> </h1> </center>
<br><br>
</table>
</form>
</html>