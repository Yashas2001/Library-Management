         ...
         <center>
            <table bgcolor="white" border="6" cellpadding="10" cellspacing="2">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" align="center"><input type="submit" value="AddUser" />
                            &nbsp;&nbsp;
                    ...
                    <tr>
                        <td ><input type="radio" name = "userType" value="1" />Admin User
                            &nbsp;&nbsp;
                        </td>
                        <td ><input type="radio" name = "userType" value="0" />Other User
                            &nbsp;&nbsp;
                        </td>                        
                    </tr>                    
                </tbody>
